...
int main()
{
    ...
    do {
            ...
            switch(operation){
                case 1 : printf("le resultat de l'addition de %.2f et %.2f est : %.2f\n",N1,N2,N1+N2);
                        break ;


                case 2 : printf("le resultat de la soustraction de %.2f et %.2f est : %.2f\n",N1,N2,N1-N2);
                            break ;
                case 3 : printf("le resultat de la multiplication de %.2f et %.2f est : %.2f\n",N1,N2,N1*N2);
                            break ;
                ...
                case 5 : printf("le resultat de le reste de division de %.2f et %.2f est : %.2f\n",N1,N2, (int) N1 % (int) N2 );
                        break ;

                case 6 : printf("le resultat de la puissance de %.2f et %.2f est : %.2f\n",N1,N2,pow(N1,N2));
                        break ;

                default : printf("saisir un nombre dans le menu ");
                          break ;
            ...
            printf("si tu peut repeter saisir 'O',sinon 'N' : ");
            scanf(" %C",&response);
